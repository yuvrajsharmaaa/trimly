 ...
 * Implements memoization, efficient filtering, and performance patterns
...
const Dashboard = () => {
  ...
  // Memoized filtered URLs - only recompute when urls or searchQuery changes
  ...
  // Animated stat component with optimization
